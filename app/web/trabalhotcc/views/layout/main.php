...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo $this->assets($theme)?>/css/agency.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="<?php echo $this->assets($theme)?>/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<body id="page-top" class="index">
   ...
   <?php 
    ...
    <script src="<?php echo $this->assets($theme)?>/js/bootstrap.min.js"></script>

    <!-- Plugin JavaScript -->
    <script src="http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>
    <script src="<?php echo $this->assets($theme)?>/js/classie.js"></script>
    <script src="<?php echo $this->assets($theme)?>/js/cbpAnimatedHeader.js"></script>

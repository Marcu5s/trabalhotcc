            ...
            <div class="login-container">
                ...
                <fieldset>
                    ...
                    <div class="input-prepend" title="Senha">
                        ...
                        <input class="input-large span10" name="Usuario[senha]" id="senha" type="password" placeholder="informe nova senha">
                    </div>
                    <div class="input-prepend" title="Senha">
                        <span class="add-on"><i class="halflings-icon lock"></i></span>
                        <input class="input-large span10" name="" id="senha" type="password" placeholder="confirme sua senha">
                    </div>
                    <br/>

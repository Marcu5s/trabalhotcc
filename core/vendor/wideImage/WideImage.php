...
use core\vendor\wideImage\WideImage_Exception;
use core\vendor\wideImage\WideImage_Image;
use core\vendor\wideImage\WideImage_TrueColorImage;
use core\vendor\wideImage\WideImage_PaletteImage;
use core\vendor\wideImage\WideImage_Coordinate;
use core\vendor\wideImage\WideImage_Canvas;
use core\vendor\wideImage\WideImage_MapperFactory;
use core\vendor\wideImage\WideImage_OperationFactory;

/**
 * @Fonts
 */

use core\vendor\wideImage\Font\WideImage_Font_TTF;
use core\vendor\wideImage\Font\WideImage_Font_GDF;
use core\vendor\wideImage\Font\WideImage_Font_PS;
  ...
  **/
	...
	class WideImage
	{
		...
		static function load($source)
		{
			...
			return call_user_func(array(new WideImage(), 'loadFrom' . $predictedSourceType), $source);
		}
